...
static const _ModbusPacket_type_support_symbol_names_t _ModbusPacket_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, modbus_driver_interfaces, msg, ModbusPacket)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, modbus_driver_interfaces, msg, ModbusPacket)),
  }
};
...
{
  return &::modbus_driver_interfaces::msg::rosidl_typesupport_cpp::ModbusPacket_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, modbus_driver_interfaces, msg, ModbusPacket)() {
  return get_message_type_support_handle<modbus_driver_interfaces::msg::ModbusPacket>();
}
