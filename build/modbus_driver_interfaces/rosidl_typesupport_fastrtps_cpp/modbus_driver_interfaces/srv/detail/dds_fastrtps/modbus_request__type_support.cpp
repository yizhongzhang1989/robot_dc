...
#include "modbus_driver_interfaces/srv/detail/modbus_request__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = modbus_driver_interfaces::srv::ModbusRequest_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const modbus_driver_interfaces::srv::ModbusRequest_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<modbus_driver_interfaces::srv::ModbusRequest_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ModbusRequest_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const modbus_driver_interfaces::srv::ModbusRequest_Request *>(
...
static size_t _ModbusRequest_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ModbusRequest_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ModbusRequest_Request__callbacks = {
...
static rosidl_message_type_support_t _ModbusRequest_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ModbusRequest_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_modbus_driver_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<modbus_driver_interfaces::srv::ModbusRequest_Request>()
{
  return &modbus_driver_interfaces::srv::typesupport_fastrtps_cpp::_ModbusRequest_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = modbus_driver_interfaces::srv::ModbusRequest_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const modbus_driver_interfaces::srv::ModbusRequest_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<modbus_driver_interfaces::srv::ModbusRequest_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ModbusRequest_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const modbus_driver_interfaces::srv::ModbusRequest_Response *>(
...
static size_t _ModbusRequest_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ModbusRequest_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ModbusRequest_Response__callbacks = {
  "modbus_driver_interfaces::srv",
...
static rosidl_message_type_support_t _ModbusRequest_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ModbusRequest_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &modbus_driver_interfaces::srv::typesupport_fastrtps_cpp::_ModbusRequest_Response__handle;
}
...
static service_type_support_callbacks_t _ModbusRequest__callbacks = {
  "modbus_driver_interfaces::srv",
  "ModbusRequest",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, modbus_driver_interfaces, srv, ModbusRequest_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, modbus_driver_interfaces, srv, ModbusRequest_Response)(),
...
static rosidl_service_type_support_t _ModbusRequest__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ModbusRequest__callbacks,
...
{
  return &modbus_driver_interfaces::srv::typesupport_fastrtps_cpp::_ModbusRequest__handle;
}
