...
```bash
ros2 launch ur_web ur15_beijing_bringup.py
```
...
```bash
ros2 launch ur_web ur15_control_launch.py
```
...
ros2 launch ur_web ur15_beijing_bringup.py ur15_ip:=192.168.1.15

# Launch with RViz visualization
ros2 launch ur_web ur15_beijing_bringup.py launch_rviz:=true
```
...
ros2 launch ur_web ur15_control_launch.py ur15_ip:=192.168.1.15
