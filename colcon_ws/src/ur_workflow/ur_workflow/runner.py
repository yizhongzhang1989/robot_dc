...
Usage:
    python3 -m ur_workflow.runner --config ur_workflow/examples/workflow_example.yaml
    python3 -m ur_workflow.runner --config workflow.yaml --dry-run
"""
...
Examples:
  ...
  python3 -m ur_workflow.runner --config ur_workflow/examples/workflow_simple.yaml
