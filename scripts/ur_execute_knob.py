...
# ================================= Movement Functions ================================
    ...
    def movel_to_right_knob(self):
        """
        Move robot to right knob position using linear movement based on crack local coordinate system.
        """
        if self.robot is None:
            print("Robot is not initialized")
            return -1
        ...
        # Step 1: Move along crack local X and Z directions (keep crack local Y unchanged)
        # Calculate intermediate position by adding crack local X and Z movements with right knob offset
        ...
        print(f"\n[Right Knob] Step 1: Moving along crack local X and Z directions...")
        print(f"Intermediate pose: {intermediate_pose}")
        ...
        print(f"\n[Right Knob] Step 2: Moving along crack local Y direction...")
        print(f"Final pose: {final_pose}")
...
if __name__ == "__main__":
    ...
    print("\n" + "="*50)
    ur_knob.movel_in_crack_frame([0, -0.001, 0])
    time.sleep(0.5)
    ...
    # move away from the knob
    print("\n" + "="*50)
    ur_knob.movel_in_crack_frame([0, -0.2, 0])
    time.sleep(0.5)
