...
def main():
    ...
    robot.movej([-1.5214603582965296, -1.5911976299681605, -0.061844415962696075, 
                 0.0634651619144897, 1.4398401975631714, -1.233070198689596], a=0.2, v=0.3)
    time.sleep(0.5)
    
    robot.movej([0.2855508029460907, -1.5912038288512171, -0.061856381595134735, 
                 0.0634731489368896, 1.439842939376831, -1.2330248991595667], a=0.2, v=0.3)
    time.sleep(0.5)
    
    robot.movej([0.28557083010673523, -1.591199060479635, -0.06185074895620346, 
                 0.04871325075115962, -1.5685623327838343, -1.2330392042743128], a=0.2, v=0.3)
    time.sleep(0.5)
    
    robot.movej([0.23396389186382294, -1.2096487444690247, -0.9661047458648682, 
                 0.6180705267139892, -0.8157733122455042, -1.3010566870318812], a=0.2, v=0.3)
    time.sleep(0.5)
    
    robot.movej([0.33506277203559875, -1.0737643104842682, -2.174562931060791, 
                 1.6773270803638916, -1.5649297873126429, -1.1772149244891565], a=0.2, v=0.3)
    time.sleep(0.5)
    
    # Move to TCP poses using movel
    robot.movel([0.29874434298501634, -0.1538160658849311, 0.5897223898809039, 
                 0.10071423562068062, 3.1388583371383447, -0.008759986213548468], a=0.2, v=0.1)
    time.sleep(0.5)
    
    robot.movel([0.29874553779036866, -0.15609230154577425, 0.1711676056642954, 
                 0.8040429473038347, 3.0321342450541757, 0.028574094050588018], a=0.2, v=0.1)
    time.sleep(0.5)
    ...
    robot.movel([0.0679248991478309, -0.917977457822281, 0.18355923789567852, 
                 1.6900325490248567, 1.8297514645801967, -0.4799504515824927], a=0.2, v=0.1)
    time.sleep(0.5)
    
    robot.movej([-1.2915375868426722, -1.5575635519674798, -0.06898311525583267, 
                 2.9911085802265625, -1.580907169972555, -1.365657154713766], a=0.2, v=0.3)
    time.sleep(0.5)
    
    robot.movej([-4.884998265896932, -1.5659199755503614, -0.06898307800292969, 
                 2.991100950832031, -1.5809772650348108, -1.365657154713766], a=0.2, v=0.3)
    time.sleep(0.5)
    
    robot.movej([-4.885191384946005, -1.2189367276481171, 1.9253881613360804, 
                 3.4605280595966796, -1.580993954335348, -1.3657320181476038], a=0.2, v=0.3)
    time.sleep(0.5)
    
    robot.movej([-4.628247443829672, -0.596695141201355, 1.2688997427569788, 
                 -1.9046498737730921, 0.12711143493652344, 3.7376646995544434], a=0.2, v=0.3)
    time.sleep(0.5)

    
    robot.movej([-4.628224555646078, -0.5939362210086365, 1.9152935186969202, 
                 -1.9046393833556117, 0.1272939145565033, 3.737786054611206], a=0.2, v=0.3)
    time.sleep(0.5)
