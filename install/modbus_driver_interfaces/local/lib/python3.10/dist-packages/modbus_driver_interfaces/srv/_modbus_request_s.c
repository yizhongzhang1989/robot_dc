...
bool modbus_driver_interfaces__srv__modbus_request__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("modbus_driver_interfaces.srv._modbus_request.ModbusRequest_Request", full_classname_dest, 66) == 0);
  }
  modbus_driver_interfaces__srv__ModbusRequest_Request * ros_message = _ros_message;
  {  // function_code
  ...
  {  // seq_id
    ...
    assert(PyLong_Check(field));
    ros_message->seq_id = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ModbusRequest_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("modbus_driver_interfaces.srv._modbus_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModbusRequest_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool modbus_driver_interfaces__srv__modbus_request__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("modbus_driver_interfaces.srv._modbus_request.ModbusRequest_Response", full_classname_dest, 67) == 0);
  }
  modbus_driver_interfaces__srv__ModbusRequest_Response * ros_message = _ros_message;
  {  // success
  ...
  {  // response
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint16_t * dest = ros_message->response.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
  ...
  {  // ack
    ...
    assert(PyLong_Check(field));
    ros_message->ack = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ModbusRequest_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("modbus_driver_interfaces.srv._modbus_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModbusRequest_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // response
    ...
    if (ros_message->response.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint16_t * src = &(ros_message->response.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->response.size * sizeof(uint16_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
